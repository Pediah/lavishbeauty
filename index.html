...
<section class="header">
    ...
    <a href="#" class="logo">
        <img src="images/lavishlogo.svg" alt="">
    </a>
    ...
    <nav class="navbar">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-content">
                <li><a href="beauty.php">Beauty Essentials</a></li>
                <li><a href="nails.php">Nail Care</a></li>
                <li><a href="barber.php">Hair Services</a></li>
            </ul>
        </div>
    </nav>
...
<section class="home" id="home">
    ...
    <div class="content">
        <span>Welcome</span>
        <h3>We make <br> hair beautiful <br> & unique</h3><br><button type="button" class="booking-button">Make A Booking</button>
    </div>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <span>by admin / 19th july, 2024</span>
...
<section class="visit" id="visit">
    ...
    <div class="row">
        <form action="book_visit.php" method="post">
            ...
            <div class="inputBox">
                <select id="department" name="department" required onchange="updateDaySlots()">
                    <option value="" disabled selected>Select Department</option>
                    <option value="department1">Beauty Essentials</option>
                    <option value="department2">Nail care</option>
                    <option value="department3">Hair Styling</option>
                </select>
            </div>
            <div class="inputBox" id="day-slot">
                <select id="day" name="day" disabled required onchange="updateTimeSlots()">
                    <option value="" disabled selected>Select Day</option>
                </select>
            </div>
            <div class="inputBox" id="time-slot">
                <select id="time" name="time" disabled required>
                    <option value="" disabled selected>Select Time Slot</option>
                </select>
            </div>
            <input type="submit" value="Place Booking" class="btn">
        </form>
    </div>
</section>
...
<section class="footer">
    ...
    <div class="box-container">
       ...
       <div class="box">
          ...
          <a href="#" class="link">*******8@gmail.com</a>
       </div>
    ...
    <div class="credit"> created by <span>Imanasoft</span> | all rights reserved! </div>
